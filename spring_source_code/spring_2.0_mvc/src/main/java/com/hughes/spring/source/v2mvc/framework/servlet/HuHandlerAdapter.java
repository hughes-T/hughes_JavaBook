...
/**
 * @author hughes-T
 * @since 2021/10/23 19:40
 */
public class HuHandlerAdapter {

    public HModelAndView handle(HttpServletRequest req, HttpServletResponse resp, HuHandlerMapping handler)throws Exception {
        ...
        boolean isModelAndView = handler.getMethod().getReturnType() == HModelAndView.class;
        if(isModelAndView){
